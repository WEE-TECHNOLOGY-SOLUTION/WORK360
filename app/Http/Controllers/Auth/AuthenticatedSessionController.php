...
class AuthenticatedSessionController extends Controller
{
    ...
    public function redirectToProvider($provider)
    {
        try {
            ...
            return redirect()->route('login')->with('error', __('Social login is not properly configured.'));
        }
    }
    ...
    public function handleProviderCallback($provider)
    {
        try {
            ...
            return redirect()->route('login')->with('error', __('Unable to authenticate with social provider.'));
        }
    }
}
