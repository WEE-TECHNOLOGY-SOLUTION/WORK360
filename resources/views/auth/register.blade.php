...
@section('content')
    ...
    <div class="">
        ...
        <div class="social-login-buttons mb-4">
            <a href="{{ route('social.login', 'google') }}" class="btn btn-block btn-google mb-2">
                <i class="fab fa-google me-2"></i>{{ __('Login with Google') }}
            </a>
            <a href="{{ route('social.login', 'tiktok') }}" class="btn btn-block btn-dark">
                <i class="fab fa-tiktok me-2"></i>{{ __('Login with TikTok') }}
            </a>
        </div>
