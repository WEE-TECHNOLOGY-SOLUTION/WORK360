...
<head>
    ...
    <meta name="title" content="{{ isset($setting['metatitle']) ? (string)$setting['metatitle'] : 'Ecommerce' }}">
    <meta name="keywords"
        content="{{ isset($setting['metakeyword']) ? (string)$setting['metakeyword'] : 'Ecommerce, Store with Multi theme and Multi Store' }}">
    <meta name="description"
        content="{{ isset($setting['metadesc']) ? (string)$setting['metadesc'] : 'Discover the efficiency of Ecommerce, a user-friendly web application by weetechnologysolution.co.' }}">


    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ env('APP_URL') }}">
    <meta property="og:title" content="{{ isset($setting['metatitle']) ? (string)$setting['metatitle'] : 'Ecommerce' }}">
    <meta property="og:description"
        content="{{ isset($setting['metadesc']) ? (string)$setting['metadesc'] : 'Discover the efficiency of Ecommerce, a user-friendly web application by weetechnologysolution.co.' }} ">
    <meta property="og:image"
        content="{{ get_file(isset($setting['metaimage']) ? (string)$setting['metaimage'] : 'storage/uploads/ecommercego-saas-preview.png') }}{{ '?' . time() }}">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ env('APP_URL') }}">
    <meta property="twitter:title"
        content="{{ isset($setting['metatitle']) ? (string)$setting['metatitle'] : 'Ecommerce' }}">
